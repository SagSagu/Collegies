package com.appmakerz.collegies.sign_in;
...
public class LoadingButton extends View {
    ...
    private void init(Context context,AttributeSet attrs){
        ...
        if(attrs != null){
            ...
            mColorPrimary = ta.getInt(com.dx.dxloadingbutton.lib.R.styleable.LoadingButton_lb_btnColor,defaultColor);
            String text = ta.getString(com.dx.dxloadingbutton.lib.R.styleable.LoadingButton_lb_btnText);
            mText = text == null ? "" : text;
            mTextColor = ta.getColor(com.dx.dxloadingbutton.lib.R.styleable.LoadingButton_lb_textColor,Color.WHITE);
            resetAfterFailed = ta.getBoolean(com.dx.dxloadingbutton.lib.R.styleable.LoadingButton_lb_resetAfterFailed,true);
            mRippleColor = ta.getColor(com.dx.dxloadingbutton.lib.R.styleable.LoadingButton_lb_btnRippleColor,Color.BLACK);
            mRippleAlpha = ta.getFloat(com.dx.dxloadingbutton.lib.R.styleable.LoadingButton_lb_btnRippleAlpha,0.3f);
            ta.recycle();
        }
